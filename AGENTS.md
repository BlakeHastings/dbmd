...
seam, with no engine behind it yet. There is no CLI and no studio. Everything
else in this file is either about the repository or about a decision already
recorded.
